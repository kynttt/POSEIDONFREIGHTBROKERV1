      ...
      <nav className="flex-1 bg-white overflow-y-auto">
        <div className=" bg-white p-6 w-full max-w-screen-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start">
            <div className="mb-4 sm:mr-20">
              <h2 className="text-lg font-normal mb-2 text-gray-500">
                Post ID
              </h2>
        ...
        <div className="bg-white p-6 w-full max-w-screen-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row mb-4">
            ...
            <div className="w-full sm:w-1/2 sm:pr-2"></div>
          </div>
        ...
        <div className="bg-white p-6 w-full max-w-screen-2xl mx-auto">
          ...
          <div>
            <p className="text-primary text-lg font-normal ">
              ...
              No Limitation of carrier liability applies to this shipment,
              unless set forth in the Transportation Agreement between the
              parties.
            </p>
            <div className="text-gray-500 text-xs grid grid-cols-1 lg:grid-cols-4 gap-4 mb-4 mt-8">
              <p className="lg:col-span-1 border-2 p-4 text-primary text-sm font-normal text-justify">
                ...
                shipper, if applicable, to the rates, classifications, and rules
                that have been established by the carrier and are applicable to
                the shipment, as well as to all applicable state and federal
                regulations.
              </p>
              <p className="lg:col-span-3 border-2 p-4 text-primary text-sm font-normal text-justify">
                ...
                service provider accepts this shipment from anyone other than
                the shipper listed hereon, it agrees to seek payment of all
                charges exclusively from this entity from which it accepted the
                shipment (i.e., the broker) and expressly waives any other
                collection rights or remedies otherwise available to it,
                including any right to seek payment of the transportation
                charges from the consignee or consignor.
            ...
            <div className="text-gray-500 text-xs grid grid-cols-1 lg:grid-cols-6 gap-4 mb-4 mt-8">
              <p className="lg:col-span-2 border-2 p-4 text-primary text-sm font-normal text-justify">
                <p className="pb-8 border-b-4 border-gray-600 font-bold">
              ...
              <p className="lg:col-span-2 border-2 p-4 text-primary text-sm font-normal text-justify">
                <p className="pb-8 border-b-4 border-gray-600">
