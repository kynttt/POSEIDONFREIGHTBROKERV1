...
import MockCheckout from './Stripe/MockCheckout';
    ...
    return (
        <>
            <div className="bg-white h-screen flex flex-col md:flex-row">
                ...
                {/* Main Content */}
                <div className="flex-1 bg-white w-full md:pt-16 overflow-y-auto  lg:pt-15 h-screen pb-16  r">
                    <div className="container mx-auto px-4 sm:px-6 ">
                        <div className="flex flex-col lg:flex-row">
                            <div className="w-full lg:w-1/2 p-4 sm:p-6 ">
                                <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-secondary">Payment Method</h2>
                                <div className="p-4 sm:p-6 lg:p-10 rounded-lg border shadow-lg">
                                    {/* Payment Method Select */}
                                    <div className="flex items-center mb-4">
                                        <FontAwesomeIcon icon={faMoneyCheckDollar} className="text-secondary mr-1" />
                                    ...
                                    <div className="overflow-x-auto bg-white rounded-lg border-1 shadow p-4 sm:p-6 lg:p-10 mt-4">
                                                    ...
                                                    <tr key={index} className="text-primary">
                                                        ...
                                                        <td className="lg:px-2 py-2 ">
                                                            <input
                                                                ...
                                                                readOnly
                                                                className="text-center block w-36 bg-white border border-gray-200 text-blue-500 py-2 px-2 lg:px-4 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                            />
                                                        </td>
                                                    </tr>
                                                ))}
                                    ...
                                    <div className="flex items-center py-5 sm:mt-4 md:mt-6 lg:mt-8">
                                        <input type="checkbox" id="agreement" className="mr-2 w-4 h-4 mb-2" />
                                        <label htmlFor="agreement" className="text-sm sm:text-base md:text-md lg:text-md mb-2 text-primary font-medium">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="text-gray-500 text-xs grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4 mt-2">
                                            <p className="lg:col-span-3 text-gray-500  text-sm font-normal text-justify">
                                ...
                                <div className="flex justify-center lg:justify-start space-x-4 lg:mt-4 mt-2">
                            ...
                            {selectedAccount === 'Stripe' && (
                                <div className="w-full lg:w-1/2 p-4 sm:p-6 lg:mt-28">
                                    <MockCheckout />
                                </div>
                            )}
                        </div>
