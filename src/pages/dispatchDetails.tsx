...
const DispatchDetails: React.FC = () => {
  return (
    <nav>
      <Navbar />
      <div className="flex flex-col items-center justify-center mt-10 md:mt-24 px-4">
        <div className="bg-white p-6 w-full md:w-8/12 overflow-x-auto md:overflow-x-hidden">
          <h2 className="text-xl font-medium text-blue-700 mb-6 text-secondary text-center md:text-left">Dispatched Details</h2>
          
          <div className="grid grid-cols-12 gap-4 mb-6 items-center min-w-max">
            <div className="text-center md:text-left col-span-3 pb-4 md:pb-0">
            ...
            <div className="text-center col-span-1 md:pr-16 hidden md:block">
              <FontAwesomeIcon icon={faAnglesRight} className="text-3xl text-secondary" />
            </div>
            <div className="text-center md:text-left col-span-2 pb-4 md:pb-0">
              <p className="text-gray-500 text-lg font-medium mb-6">Drop</p>
              <p className="text-base mb-1 text-primary">Los Angeles, CA</p>
              <p className="text-sm font-medium text-primary">Sat 06/27/2024</p>
            </div>
            <div className="text-center md:text-left col-span-2 lg:border-r-2 lg:border-secondary md:border-secondary pb-6 md:pb-0">
              <p className="text-gray-500 text-lg font-medium mb-2">3 Total Stops</p>
              <p className="text-base text-primary">3043 mi</p>
            </div>
            <div className="text-center md:text-center col-span-2 pb-4 md:pb-0">
              <p className="text-xl font-medium text-primary">0 mi DH</p>
            </div>
            <div className="text-center md:text-left col-span-2 lg:border-l-2 lg:border-secondary md:border-secondary pb-4 md:pb-0 pl-6">
              <p className="text-gray-500 text-lg font-medium mb-2">Max. Weight</p>
              <p className="text-xl font-medium text-primary">41,000 lbs.</p>
            </div>
          </div>

          {/* Scrollable Additional Details section */}
          <h2 className="text-xl font-medium text-secondary mb-5 text-center md:text-left">Additional Details</h2>
          <div className="overflow-x-auto">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center min-w-max">
              <div className="text-center md:text-left col-span-1 pb-4 md:pb-0">
              ...
              <div className="text-center md:text-right col-span-1 pb-4 md:pb-0">
