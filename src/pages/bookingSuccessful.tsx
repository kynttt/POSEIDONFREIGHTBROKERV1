  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-10 px-4 md:px-8 lg:px-16 xl:px-24 bg-gray-100">
      <div className="p-6 max-w-lg w-full text-center border shadow-lg rounded-lg">
        <h1 className="text-4xl text-secondary font-normal mb-6">
          Booking Successful!
        </h1>
        <p className="text-xl font-light text-gray-500 tracking-wider py-6">
        ...
        <div className="flex justify-center items-center">
          <Button
            ...
            className="extra-class-for-medium-button my-6"
            type={""}
          />
        </div>
      </div>
