  ...
  const dashboardData = [
    {
      additionalInfo: (
        <span className="flex items-center">
          <span className="mr-1 text-4xl lg:text-5xl font-semibold text-primary mt-3">
            100%
          </span>
    ...
    },
    {
      additionalInfo: (
        <span className="flex items-center">
          <span className="mr-1 text-4xl lg:text-5xl font-semibold text-primary mt-4">
            99.9%
          </span>
          <span className="flex text-xs font-normal">
      ...
      additionalInfo: (
        <span className="flex items-center">
          ...
          <span className="flex text-xs font-normal">
            <FontAwesomeIcon
              icon={faCaretUp}
              className="text-green-200 mt-5 px-2"
            />
            0.3% <br /> 1 week
          </span>
        </span>
