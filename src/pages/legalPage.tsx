...
import { faFolderOpen, faSearch, faArrowUpFromBracket, faPlus, faEllipsisV } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between items-start mt-4 mb-4 px-4 sm:px-6 md:px-12">
      <div className="mb-4 md:mb-8">
        <h2 className="text-sm font-light text-secondary">Hello Legal Team,</h2>
    ...
    <div className="mb-8 px-4 sm:px-6 md:px-32">
      <h3 className="text-xl font-medium text-secondary mb-8">All Folders</h3>
      <div className="flex gap-4 overflow-x-auto gap-x-12">
        {folders.map((folder) => (
          <div key={folder} className="text-sm flex-shrink-0 border-2 border-secondary rounded-lg p-4 text-center text-primary" style={{ minWidth: '150px', maxWidth: '150px', minHeight: '100px' }}>
