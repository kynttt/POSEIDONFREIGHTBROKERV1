...
const BrokerShipperAgreement: React.FC = () => {
  ...
  const { data, isLoading, isError, error } = useQuery<User, AxiosError>({
    ...
    return (
        <>
        <div className="print-container max-w-4xl mx-auto p-8 md:px-24 bg-white shadow-md">
                ...
                <p className="text-base font-normal pb-24  text-justify">
                ...
                <h3 className="text-base font-normal mt-36 mb-4">
                    8. Lien on Cargoes.
                </h3>
                <ul className="text-base font-normal list-disc pl-8 mb-4 space-y-2 text-justify">
                    <li>
            ...
            <ul className="text-base font-normal list-disc pl-8 mb-4 space-y-2 text-justify">
                ...
                <h3 className="text-base font-normal mt-8 mb-12 text-justify">
                ...
                <h3 className="text-base font-normal pt-28  mb-4 text-justify">
                ...
                <h3 className="text-base font-normal mt-52 mb-4 text-justify">
                ...
                <p className="text-base font-medium mt-60 mb-4 text-justify">
                ...
                <button
                    ...
                    className="mt-8 ml-4 bg-blue-600 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded"
                >
                    Download as PDF
                </button>
                </>
