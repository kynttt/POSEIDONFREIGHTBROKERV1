    ...
    <div className="m-2 flex items-center justify-center min-h-screen bg-light-grey">
      <div className="w-full max-w-lg p-8 bg-white rounded-lg shadow-md">
        <h2 className="text-2xl font-semibold text-primary mb-1 flex items-center">
          <FontAwesomeIcon
            icon={faUserEdit}
            className="mr-2 w-4 h-4 p-2 text-primary bg-grey rounded-full"
          />
          Account
        </h2>
          ...
          <div className="mb-4 p-3 text-sm text-red-500 border border-red-300 rounded-md bg-red-50 flex items-center space-x-2">
            ...
            >
              <path
                ...
                strokeWidth="2"
                d="M12 8v4m0 4h.01M4.293 4.293a1 1 0 00-1.415 1.414L5.586 8 3.878 9.707a1 1 0 001.414 1.415L7 9.415l2.707 2.707a1 1 0 001.415-1.414L8.415 8l2.707-2.707a1 1 0 00-1.415-1.414L7 6.586 4.293 3.879a1 1 0 00-1.415 1.414z"
              />
            </svg>
            <span>{error}</span>
          </div>
