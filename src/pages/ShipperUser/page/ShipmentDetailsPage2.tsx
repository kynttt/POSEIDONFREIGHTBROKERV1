                    ...
                    <div className="w-full p-2">
                        ...
                        <div className="md:flex items-center justify-between bg-blue-50 p-6 w-full max-w-screen mx-auto ">
                            <h1 className="md:text-2xl text-lg font-medium mb-4 mt-4 text-rblue">
                                Shipment Reference: {booking.bolNumber}
                            </h1>
                                ...
                                <div className="w-full sm:w-1/2 mb-4 sm:mb-0">
                                    {billOfLading ? (
                                        ...
                                        <button
                                            ...
                                            className={`block text-primary text-sm font-bold p-2 rounded-md ${booking.status === "Pending"
                                        ...
                                        <p className="text-xs text-gray-400 font-light">* Please review this information once our dispatcher has confirmed the shipment.</p>
                                        </>
                                    )}
                                </div>
                            </div>
