import Image1 from "../assets/img/booking.png"; // Import your image
  ...
  return (
    ...
    <div className="relative h-auto w-full overflow-hidden pt-24">
      ...
      >
        ...
        <div className="absolute top-0 md:top-36 bg-lyellow text-darkBlue md:p-0 lg:pl-72 lg:pr-20 rounded-md w-11/12 md:w-auto z-30">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="py-8 md:py-16 bg-white bg-opacity-90 w-full">
          <div className="w-full md:w-4/5 lg:w-3/4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 md:gap-10 lg:gap-16 text-center mx-auto">
