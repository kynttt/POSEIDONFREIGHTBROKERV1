...
const Folder: React.FC<FolderProps> = ({ name }) => {
  return (
    <div className="text-sm flex-shrink-0 border-2 border-secondary rounded-lg p-4 text-center text-primary" style={{ minWidth: "150px", maxWidth: "150px", minHeight: "100px" }}>
