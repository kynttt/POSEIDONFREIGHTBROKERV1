...
const HeroBanner: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="text-left md:px-30 lg:px-40 mt-24 md:mt-32 lg:mt-48">
        <h1
          className="
      ...
      <img
        src={heroBanner}
        alt="Hero Banner"
        className="absolute right-0 top-0 md:top-5 w-[80%] md:w-[60%] lg:w-[45%] xl:w-[40%] h-auto object-contain"
