...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <div className="bg-white flex flex-col items-center lg:flex-row lg:items-start px-4 md:px-8 lg:px-36 lg:py-8">
      {/* Image Section */}
      <div
        className={`w-full lg:w-1/3 text-center mb-8 transition-transform duration-1000 ${imageInView ? 'transform-none opacity-100' : 'transform -translate-x-20 opacity-0'
          }`}
        ref={imageRef}
      >
      ...
      <div className="w-full lg:w-2/3 mt-8 lg:mt-18">
        <div className="lg:mt-36 flex flex-col lg:grid lg:grid-cols-2 gap-20">
          <div
            className={`bg-white transition-transform duration-1000 ${textInView1 ? 'transform-none opacity-100' : 'transform translate-x-20 opacity-0'
              }`}
            ref={textRef1}
          >
          ...
          <div
            className={`bg-white transition-transform duration-1000 ${textInView2 ? 'transform-none opacity-100' : 'transform translate-x-20 opacity-0'
              }`}
            ref={textRef2}
          >
        ...
        <div
          className={`bg-white text-center my-20 transition-transform duration-1000 ${textInView3 ? 'transform-none opacity-100' : 'transform translate-x-20 opacity-0'
            }`}
          ref={textRef3}
        >
          <div className="text-center">
