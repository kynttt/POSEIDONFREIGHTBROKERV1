  ...
  return (
    <div id='services' className="py-5">
      ...
      <div ref={ref} className={`flex flex-col md:flex-row justify-between items-center px-6 md:px-32 mt-10 md:mt-16 mb-16 transition-transform duration-1000 ${inView ? 'md:transform-none md:opacity-100' : 'md:transform md:translate-y-20 md:opacity-0'}`}>
        <div className="w-full md:w-1/3  text-center md:text-center mb-4 md:mb-0 ">
          ...
          <p className="text-sm font-light">Tailored Carrier Services to Fit Your Business</p>
        </div>
        <div className="w-full md:w-1/3  text-center md:text-center mb-4 md:mb-0">
          ...
          <p className="text-sm font-light">Driving Your Business Forward with Expert Logistics Support</p>
        </div>
        <div className="w-full md:w-1/3  text-center md:text-center mb-4 md:mb-0">
          ...
          <p className="text-sm font-light">Optimizing Your Shipping Process for Maximum Efficiency</p>
        </div>
      </div>
    </div>
  );
