...
const AboutUs: React.FC = () => {
  return (
    <div className="bg-[#eaeefa] flex flex-col lg:flex-row items-center lg:items-start px-4 md:px-8 lg:px-20 xl:px-32 gap-8 lg:gap-20">
      {/* Image Section */}
      
      <div className="w-full lg:w-1/2 flex justify-center items-center mb-10 lg:order-last">
        <img src={AboutImage} alt="About Us" className="w-full h-auto lg:max-h-full object-cover object-center" />
      </div>

      {/* Content Section */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center text-[#252F70] max-w-prose lg:ml-2px lg:mt-40 mb-5">
        <p className="text-xl font-medium mb-4 lg:mb-8">About Us</p>
        <h1 className="text-3xl text-gray-600 mb-4 lg:mb-8 text-primary">Transport and Logistics</h1>
