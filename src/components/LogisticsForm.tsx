  ...
  return (
    <APIProvider apiKey={googleMapsApiKey}>
      <div className="relative ">
        ...
        <div className="absolute inset-0 bg-black opacity-70 md:opacity-50 sm:block md:block lg:opacity-0 "></div>
      ...
      <div className="relative w-full h-3/4">
        ...
        <div className="absolute inset-0 bg-black opacity-70 md:opacity-50 lg:opacity-0" />
